export default function loadCharacters(name='all') {
  const characters = [
    ...
    },
    {
      ...
      seasons: [1, 2, 3, 4, 5, 6, 7, 8, 9],
      occupation: 'Receptionist',
      aliases: ['Pama-lama-ding-dong', 'Big Pregs', 'Beesly', 'Office Mattress', 'PamPam and her Pam Pams', 'Bart Simpson of Scranton', 'Pam-Pam!', 'Pam, Pam, thank you ma\'am', 'Pam-burger-with-cheese', 'Pamera', 'Pam-M-S', 'Pan', 'Spamster', 'Pam, Ms. Beesly if you\'re nasty', 'Ampay', 'Christmas Pam', 'Candied Pams', 'Pam-Chop', 'Pamcasso', 'Pamcake', 'Pam-ola', 'Pretty Pam', 'Pammy', 'Little Miss Thing', 'New York'],
      brands: 'Scranton',
